...
curl --retry 10 --retry-max-time 60 -H "Cache-Control: no-cache" -fsSL github.com/v2fly/v2ray-core/releases/download/v5.4.1/v2ray-linux-64.zip -o ${DIR_TMP}/v2ray_dist.zip
